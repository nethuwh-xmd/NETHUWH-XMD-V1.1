...
const sessdata = config.SESSION_ID.replace("ZORA~OBcnVJSZ#lyWpTFUNsxrsnHBGADYPa4QONV8JyFQh0VvUdUBaar0", '');
...
if (!isReact && config.CUSTOM_REACT === 'true') {
  ...
  app.get("/", (req, res) => {
  res.send("NETHUWH XMD V1 STARTED ✅");
  });
